...
class UserCommand extends Command {
  ...
  async main(message, args) {
    ...
    description.push(`${message.dot} ${message._('user.status')}: ${message.emote((user.presence.clientStatus && user.presence.clientStatus.mobile) === 'online' ? 'mobile' : user.presence.status, true)} **${message._(`user.statusDesc.${user.presence.status}`)}**`);
