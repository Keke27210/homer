...
class WeatherCommand extends Command {
  ...
  async execute(context) {
    ...
    const currently = [
      ...
      `${this.dot} ${context.__('weather.embed.precip')}: ${weatherData.currently.precipIntensity < 0.5 ? context.__('global.none') : `**${context.__(`weather.precip.${weatherData.currently.precipType}`)}** - **${weatherData.currently.precipIntensity}**mm/h (**${(weatherData.currently.precipIntensity / 25.4)}**in/h)`}`,
